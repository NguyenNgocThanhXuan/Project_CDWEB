...
<link
	...
	rel="stylesheet" />
<link
	href="${pageContext.request.contextPath}/admin/assets/css/now-ui-dashboard.css?v=1.5.0"
	rel="stylesheet" />
<!-- CSS Just for demo purpose, don't include it in your project -->
<link
	href="${pageContext.request.contextPath}/admin/assets/demo/demo.css"
	rel="stylesheet" />
</head>
...
<body class="">
	...
	<script
		src="${pageContext.request.contextPath}/admin/assets/js/core/jquery.min.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath}/admin/assets/js/plugins/perfect-scrollbar.jquery.min.js"></script>
	<!--  Google Maps Plugin    -->
	...
	<script
		src="${pageContext.request.contextPath}/admin/assets/js/now-ui-dashboard.min.js?v=1.5.0"
		type="text/javascript"></script>
	<!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
	<script
		src="${pageContext.request.contextPath}/admin/assets/demo/demo.js"></script>
	<script>
