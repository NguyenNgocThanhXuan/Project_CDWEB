				...
				<div class="container">
					<div class="row">
						<div class="tg-aboutus">
							...
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<figure>
									<img src="${pageContext.request.contextPath}/web/images/placeholder.jpg" alt="image description">
						...
						<div class="tg-successstory">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div id="tg-successslider" class="tg-successslider tg-success owl-carousel">
									<div class="item">
										<figure>
											<img src="${pageContext.request.contextPath}/web/images/img-01.jpg" alt="image description">
										</figure>
					...
					<div class="row">
						...
						<div id="tg-teamsslider" class="tg-authors tg-authorsslider tg-teamsmember owl-carousel">
							<div class="item tg-author tg-member">
								<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/web/images/team/img-01.jpg" alt="image description"></a></figure>
							...
							<div class="item tg-author tg-member">
								<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/web/images/team/img-02.jpg" alt="image description"></a></figure>
								<div class="tg-authorcontent">
							...
							<div class="item tg-author tg-member">
								<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/web/images/team/img-03.jpg" alt="image description"></a></figure>
								<div class="tg-authorcontent">
							...
							<div class="item tg-author tg-member">
								<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/web/images/team/img-04.jpg" alt="image description"></a></figure>
								<div class="tg-authorcontent">
							...
							<div class="item tg-author tg-member">
								<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/web/images/team/img-05.jpg" alt="image description"></a></figure>
								<div class="tg-authorcontent">
