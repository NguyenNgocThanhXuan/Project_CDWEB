											...
											<div class="tg-featureditm">
												<div class="row">
													<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 hidden-sm hidden-xs">
														<figure><img src="${pageContext.request.contextPath}/web/images/img-04.png" alt="image description"></figure>
													</div>
										...
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
												<div class="tg-postbook">
													<figure class="tg-featureimg"><img src="${pageContext.request.contextPath}/web/images/books/img-07.jpg" alt="image description"></figure>
											...
											<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
												<div class="tg-productcontent">
													...
													<div class="tg-alsoavailable">
														<figure>
															<img src="${pageContext.request.contextPath}/web/images/img-02.jpg" alt="image description">
															<figcaption>
...
voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
																<figure class="tg-alignleft">
																	<img src="${pageContext.request.contextPath}/web/images/placeholdervtwo.jpg" alt="image description">
												...
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
													...
													<div class="tg-authorbox">
														<figure class="tg-authorimg">
															<img src="${pageContext.request.contextPath}/web/images/author/imag-24.jpg" alt="image description">
														</figure>
									...
									<div class="tg-widget tg-widgetblogers">
										...
										<div class="tg-widgetcontent">
											<ul>
												...
												<li>
													<div class="tg-author">
														<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/web/images/author/imag-04.jpg" alt="image description"></a></figure>
														<div class="tg-authorcontent">
															<h2><a href="javascript:void(0);">Jude Morphew</a></h2>
															<span>21,658 Published Books</span>
														</div>
												...
												<li>
													<div class="tg-author">
														<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/web/images/author/imag-05.jpg" alt="image description"></a></figure>
														<div class="tg-authorcontent">
															<h2><a href="javascript:void(0);">Jude Morphew</a></h2>
															<span>21,658 Published Books</span>
														</div>
												...
												<li>
													<div class="tg-author">
														<figure><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/web/images/author/imag-06.jpg" alt="image description"></a></figure>
														<div class="tg-authorcontent">
															<h2><a href="javascript:void(0);">Jude Morphew</a></h2>
															<span>21,658 Published Books</span>
														</div>
