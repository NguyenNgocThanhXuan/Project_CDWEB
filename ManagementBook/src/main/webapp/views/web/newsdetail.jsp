						...
						<div id="tg-twocolumns" class="tg-twocolumns">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<figure class="tg-newsdetailimg">
									<img src="${pageContext.request.contextPath}/web/images/img-03.jpg" alt="image description">
									<figcaption class="tg-author">
										<img src="${pageContext.request.contextPath}/web/images/author/imag-26.jpg" alt="image description">
									...
									<div class="tg-newsdetail">
										...
										<div class="tg-nextprevpost">
											<div class="tg-prevpost">
												<a href="javascript:void(0);">
													<figure>
														<img src="${pageContext.request.contextPath}/web/images/img-04.jpg" alt="image description">
													</figure>
													<div class="tg-posttitle">
											...
											<div class="tg-nextpost">
												<a href="javascript:void(0);">
													<figure>
														<img src="${pageContext.request.contextPath}/web/images/img-05.jpg" alt="image description">
													</figure>
													<div class="tg-posttitle">
